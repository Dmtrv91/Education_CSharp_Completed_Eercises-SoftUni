...
//която намира всички подмножества от числа от масива, които имат сума N.Например, ако имаме масива { 2, 3, 1, -1} и N = 4, можем да
п//олучим N=4 като сума по следните два начина: 4=2+3-1; 4=3+1.

namespace ConsoleAppGlava10Exercises8
{
    class Program
    {
